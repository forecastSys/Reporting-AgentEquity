...
class YFinanceAnalyzer(FinDataValidator):
    """
    ...
    @apply_selection
    def get_past_income_statement(self,
                                  n_years: int = None,
                                  n_quarters: int = None) -> pd.DataFrame:
    ...
    @apply_selection
    def get_past_balance_sheet(self,
                               n_years: int = None,
                               n_quarters: int = None) -> pd.DataFrame:
    ...
    def get_past_income_statement_growth(self,
                                         n_years: int = None,
                                         n_quarters: int = None) -> pd.DataFrame:
    ...
    @apply_selection_growth
    def get_past_balance_sheet_growth(self,
                                      n_years: int = None,
                                      n_quarters: int = None) -> pd.DataFrame:
    ...
    @apply_selection_growth
    def get_past_cash_flow_growth(self,
                                  n_years: int = None,
                                  n_quarters: int = None) -> pd.DataFrame:
    ...
    #     """Get selected cash flow growth data
    #     kwargs:
    #         n_years / n_quarters (max 4): number of years data to return / number of quarters to return
    #         selected_columns: list of column to return
    #     """
    #     return self.get_past_quarterly_cash_flow() if quarterly else self.get_past_yearly_cash_flow()
    #
...
if __name__ == "__main__":
    # Example usage:
    analyzer = YFinanceAnalyzer("INTC")
    # analyzer.get_price()
    # analyzer.get_past_yearly_income_statement()
    # analyzer.get_past_yearly_balance_sheet()
    # analyzer.get_past_yearly_cash_flow()
    ...
    # print(analyzer.get_selected_income_statement(n_years=3))
    print(analyzer.get_past_income_statement(n_years=3, selected_columns=['ebitda']))

    # print(analyzer.get_selected_financial(n_years=4, selected_columns=['Total Revenue', 'EBITDA']))

    # print(analyzer.get_selected_balance_sheet(n_quarters=4, selected_columns=['Receivables', 'Accounts Receivable']))
