...
# CUSTOM_STYLE, TITLE_STYLE, DOWN_TITLE_STYLE, SUBTITLE_STYLE, \
#     TITLE_TABLE_STYLE, TABLE_STYLE, STYLE_COMMAND = (
#     ReportLabStyles.CUSTOM_STYLE, ReportLabStyles.TITLE_STYLE, ReportLabStyles.DOWN_TITLE_STYLE,
#     ReportLabStyles.SUBTITLE_STYLE,
...
class CombinedReportPDF(ReportLabStyles,
    ...
    def create_pdf(self):
        ...
        five_frame_template = self._get_five_frame()

        doc.addPageTemplates([five_frame_template, two_column_frame, single_column_frame])
        ...
        content.append(KeepInFrame(
            ...
            title_h,
            [
            Paragraph(f"AIDF Caesars Analyst Report  |  Report as of {date.today()}  |  Reporting Currency: USD  |  Exchange: NASDAQ", self.TITLE_STYLE),
            HRFlowable(
                 width="100%",  # full frame width
                 thickness=0.5,  # line thickness
                 color=colors.black,  # match your title color
                 spaceBefore=2,  # gap above the line
                 spaceAfter=4  # gap below before next paragraph
             )
             ],
            mode = 'shrink'
        ))
    ...
    [
        ...
        col_widths = [(self.TOP_DOWN_LEFT_W - margin * 4) * 1.2 / df_shape[1]] * df_shape[1]
        ...
        full_length = self.TOP_DOWN_RIGHT_W - 2 * margin
        ...
        tbl = Table([[Image(caesars_path, width=width, height=height, hAlign='LEFT'), para]], style=self.DOWN_TITLE_TABLE_STYLE)
        content.append(KeepInFrame(
            self.USABLE_W,  # maxWidth
            title_h,
            [
        ...
        # content.append(FrameBreak())
        # content.append(KeepInFrame(
        #     bottom_right_title_usable_w,  # maxWidth
        #     title_h,
        #     [
        #         Paragraph(f'Copyright ©{datetime.datetime.today().year} Asian Institute of Digital Finance. All rights reserved.', DOWN_TITLE_STYLE)
        #     ],
        #     mode='shrink'
        # ))
